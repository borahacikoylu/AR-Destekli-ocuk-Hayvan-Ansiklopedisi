export const ANIMALS = [
  {
    ...
    targetImage: require('../../assets/targets/markers/page1_aslan_marker.jpg'),
    model: require('../../assets/models/aslan.glb'),
    sound: require('../../assets/sounds/aslan.mp3'),
    physicalWidth: 0.094,
    modelScale: [0.009, 0.009, 0.009],
  ...
  },
  {
    ...
    targetImage: require('../../assets/targets/markers/page2_fil_marker.jpg'),
  ...
  },
  {
    ...
    targetImage: require('../../assets/targets/markers/page3_kaplan_marker.jpg'),
  ...
  },
  {
    ...
    targetImage: require('../../assets/targets/markers/page4_zurafa_marker.jpg'),
    model: require('../../assets/models/zurafa.glb'),
    sound: require('../../assets/sounds/zurafa.mp3'),
    physicalWidth: 0.094,
    modelScale: [0.0015, 0.0015, 0.0015],
  ...
  },
  {
    ...
    targetImage: require('../../assets/targets/markers/page5_penguen_marker.jpg'),
    model: require('../../assets/models/penguen.glb'),
    sound: require('../../assets/sounds/penguen.mp3'),
    physicalWidth: 0.094,
    modelScale: [0.0017, 0.0017, 0.0017],
    modelPosition: [0, 0.02, 0],
    modelRotation: [-90, 0, 0],
  },
];
